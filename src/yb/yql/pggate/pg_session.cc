...
Status PgSession::SetActiveSubTransaction(SubTransactionId id, bool yb_send_active_sub_txn_rpc) {
  ...
  if (yb_send_active_sub_txn_rpc)
  {
    ...
    RETURN_NOT_OK(pg_client_.SetActiveSubTransaction(id, options_ptr));
  }
