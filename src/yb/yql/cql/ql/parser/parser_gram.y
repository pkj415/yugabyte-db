...
%type <PDmlWritePropertyListNode>   opt_update_properties write_dml_property update_properties
...
UpdateStmt:
  ...
  opt_where_or_current_clause opt_returns_clause opt_update_properties {
...
update_properties:
  ...
  | update_properties AND write_dml_property {
    $1->AppendList($3);
    $$ = $1;
  }
;
